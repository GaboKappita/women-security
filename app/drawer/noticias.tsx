    ...
    <ScrollView className="bg-[#F5F5F5] flex w-full ">
      ...
      >
        <Text className="text-base">
          Ya está en desarrollo Womens Security'
        </Text>
        <Text className="text-sm mb-4">
          La innovadora aplicación Womens Security ya se encuentra en
          desarrollo. La app en un inicio se pensaba llevar a cabo con ciertas
          limitaciones, sin embargo, gracias a las oportunidades brindadas al
          equipo, esta será mucho más completa de lo previsto.
        </Text>
      </TouchableOpacity>
      <TouchableOpacity
        activeOpacity={1}
