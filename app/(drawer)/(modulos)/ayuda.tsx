    ...
    <ImagenBackground>
      <SafeAreaView className='flex-1 p-4'>
        ...
        <Swiper
          ...
          dotStyle={{ backgroundColor: 'rgba(0,0,0,.2)', width: 8, height: 8, borderRadius: 4, margin: 3 }}
          activeDotStyle={{ backgroundColor: '#000', width: 10, height: 10, borderRadius: 5, margin: 3 }}
        ...
        >
          ...
          <View className='flex flex-col items-center p-4 bg-red-400 h-full rounded'>
            ...
            <Text className='w-10/12 text-justify mb-4'>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam fuga optio in voluptatem est numquam debitis vero, repellat quos
              placeat! Eius soluta veritatis architecto ullam sed? Incidunt, quo. Animi, dicta?
            </Text>
            <Text>(Imagen)</Text>
