      ...
      <ScrollView className="flex w-full">
        <View className="flex justify-center h-screen p-4 w-full">
          <CardBlack>
            ...
            />
            <Text className="text-center text-base text-white mb-4">
              Ingrese el correo electrónico para enviar instrucciones de
              restableciiento de contraseña.
            </Text>
            <TextInput
              className="bg-gray-200 my-2 mx-2 p-2 rounded"
